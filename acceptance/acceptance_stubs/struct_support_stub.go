...
type StructSupportStub struct {
	MethodStub        func(arg1 struct{ Input alias1.Address }) (result1 struct{ Output alias1.Address })
	methodMutex       sync.RWMutex
	methodArgsForCall []struct {
		arg1 struct{ Input alias1.Address }
	}
	methodReturns struct {
		result1 struct{ Output alias1.Address }
	}
}

func (stub *StructSupportStub) Method(arg1 struct{ Input alias1.Address }) struct{ Output alias1.Address } {
...
func (stub *StructSupportStub) MethodArgsForCall(index int) struct{ Input alias1.Address } {
	stub.methodMutex.RLock()
	defer stub.methodMutex.RUnlock()
	return stub.methodArgsForCall[index].arg1
}
func (stub *StructSupportStub) MethodReturns(result1 struct{ Output alias1.Address }) {
	stub.methodMutex.Lock()
	defer stub.methodMutex.Unlock()
