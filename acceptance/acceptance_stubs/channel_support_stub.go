...
type ChannelSupportStub struct {
	MethodStub        func(arg1 chan alias1.Address) (result1 chan alias1.Address)
	methodMutex       sync.RWMutex
	methodArgsForCall []struct {
		arg1 chan alias1.Address
	}
	methodReturns struct {
		result1 chan alias1.Address
	}
}

func (stub *ChannelSupportStub) Method(arg1 chan alias1.Address) chan alias1.Address {
...
func (stub *ChannelSupportStub) MethodArgsForCall(index int) chan alias1.Address {
	stub.methodMutex.RLock()
	defer stub.methodMutex.RUnlock()
	return stub.methodArgsForCall[index].arg1
}
func (stub *ChannelSupportStub) MethodReturns(result1 chan alias1.Address) {
	stub.methodMutex.Lock()
	defer stub.methodMutex.Unlock()
